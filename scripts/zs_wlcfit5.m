...
% -Plot event fits over the zeroed and inverted data; printed 'wlc5_2-8.png'
% -Return WLC model parameters with stats as 'Lc5fit.dat' and 'P5fit.dat'
...
%*******************************************************************
% Query peak indices.
x3=z1(locs5(2)+200:locs5(3));
y3=f1(locs5(2)+200:locs5(3));

x4=z1(locs5(3)+5:locs5(4));
y4=f1(locs5(3)+5:locs5(4));

x5=z1(locs5(4)+5:locs5(5));
y5=f1(locs5(4)+5:locs5(5));

x6=z1(locs5(5)+5:locs5(6));
y6=f1(locs5(5)+5:locs5(6));

x7=z1(locs5(6)+5:locs5(7));
y7=f1(locs5(6)+5:locs5(7));

x8=z1(locs5(7)+5:locs5(8));
y8=f1(locs5(7)+5:locs5(8));

x9=z1(locs5(8)+5:locs5(9));
...
plot(xx9,fitted9,'r','LineWidth',1);
hold off
print(fits5,'-dpng','wlc5_3-9');
...
csvwrite('Lc5fit.dat',vertcat(f5tlC,av5Lc,std5Lc));
csvwrite('P5fit.dat',vertcat(f5tp,av5p,std5p));